      ...
      <section className="u-container">
        ...
        <div className={styles["curator-layout"]}>
            <article className={styles["curator-text"]}>
                <p className={styles["margin-top-0"]}>Hi! I’m <Link href="https://danilocangucu.net">Danilo Canguçu</Link>, and music has always been a big part of my life. I listen to a huge amount of it every day. It helps me focus when I’m working, relax and travel somewhere else in my mind, and stay connected to my mother tongue and Brazilian roots — among many other things.</p>
                ...
                <p className={styles["margin-bottom-0"]}>That wish to share Brazilian music in an open and welcoming way has never left me. I am offering this mini-course again and it would be a pleasure to have you with me!</p>
            </article>
